# -*- coding: utf-8 -*-
#
# gensim_package documentation build configuration file, created by
...
latex_documents = [
    ('index', 'gensim_package.tex', u'gensim_package Documentation', u'Radim Řehůřek', 'manual'),
]
