...
and then transform any sentence (list of token strings) using the standard gensim_package syntax:
...
:mod:`gensim_package.models.word2vec` module for an example application of using phrase detection.
...
class Phrases(interfaces.TransformationABC):
    ...
    def __init__(self, sentences=None, min_count=5, threshold=10.0,
        ...
        :class:`Text8Corpus` or :class:`LineSentence` in the :mod:`gensim_package.models.word2vec`
    ...
    def __getitem__(self, sentence):
        ...
        """
        warnings.warn("For a faster implementation, use the gensim_package.models.phrases.Phraser class")
        try:
