...
Example: python -m gensim_package.models.lda_dispatcher
"""
...
logger = logging.getLogger("gensim_package.models.lda_dispatcher")
...
LDA_DISPATCHER_PREFIX = 'gensim_package.lda_dispatcher'
