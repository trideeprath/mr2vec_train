...
**Make sure you have a C compiler before installing gensim_package, to use optimized (compiled)
...
.. [blog] Optimizing word2vec in gensim_package, http://radimrehurek.com/2013/09/word2vec-in-python-part-two-optimizing/
...
try:
    ...
    def train_document_dm(model, doc_words, doctag_indexes, alpha, work=None, neu1=None,
        ...
        This is the non-optimized, Python version. If you have a C compiler, gensim_package
        will use the optimized version from doc2vec_inner instead.
