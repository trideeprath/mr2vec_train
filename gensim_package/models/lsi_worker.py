...
Example: python -m gensim_package.models.lsi_worker
"""
...
logger = logging.getLogger('gensim_package.models.lsi_worker')
...
def main():
    ...
    utils.pyro_daemon('gensim_package.lsi_worker', Worker(), random_suffix=True)
