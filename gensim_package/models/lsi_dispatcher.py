...
Example: python -m gensim_package.models.lsi_dispatcher
"""
...
logger = logging.getLogger("gensim_package.models.lsi_dispatcher")
...
class Dispatcher(object):
    ...
    def initialize(self, **model_params):
        ...
        with utils.getNS() as ns:
            self.callback = Pyro4.Proxy('PYRONAME:gensim_package.lsi_dispatcher') # = self
            for name, uri in iteritems(ns.list(prefix='gensim_package.lsi_worker')):
                try:
...
def main():
    ...
    utils.pyro_daemon('gensim_package.lsi_dispatcher', Dispatcher(maxsize=maxsize))
