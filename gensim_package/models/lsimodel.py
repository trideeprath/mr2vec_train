...
Wall-clock `performance on the English Wikipedia <http://radimrehurek.com/gensim_package/wiki.html>`_
...
class LsiModel(interfaces.TransformationABC, basemodel.BaseTopicModel):
    ...
    .. [2] https://github.com/piskvorky/gensim_package/wiki/Recipes-&-FAQ#q4-how-do-you-output-the-u-s-vt-matrices-of-lsi
    ...
    def __init__(self, corpus=None, num_topics=200, id2word=None, chunksize=20000,
        ...
        if not distributed:
            ...
            try:
                import Pyro4
                dispatcher = Pyro4.Proxy('PYRONAME:gensim_package.lsi_dispatcher')
...
#            self.print_debug(10)
    ...
    def __getitem__(self, bow, scaled=False, chunksize=512):
        ...
        # convert a numpy array to gensim_package sparse vector = tuples of (feature_id, feature_weight),
