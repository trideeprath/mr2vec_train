...
logger = logging.getLogger('gensim_package.models.ldaseqmodel')
...
class LdaSeqModel(utils.SaveLoad):
    ...
    def __init__(self, corpus=None, time_slice=None, id2word=None, alphas=0.01, num_topics=10,
                initialize='gensim_package', sstats=None,  lda_model=None, obs_variance=0.5, chain_variance=0.005, passes=10,
                random_state=None, lda_inference_max_iter=25, em_min_iter=6, em_max_iter=20, chunksize=100):
        """
        `corpus` is any iterable gensim_package corpus
        ...
        `initalize` allows the user to decide how he wants to initialise the DTM model. Default is through gensim_package LDA.
    ...
    def lda_seq_infer(self, corpus, topic_suffstats, gammas, lhoods, iter_, lda_inference_max_iter, chunksize):
        """
        Inference or E- Step.
        This is used to set up the gensim_package LdaModel to be used for each time-slice.
