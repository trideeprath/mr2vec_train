...
logger = logging.getLogger('gensim_package.corpora.ucicorpus')
...
class UciCorpus(UciReader, IndexedCorpus):
    ...
    def __iter__(self):
        """
        Interpret a matrix in UCI bag-of-words format as a streamed gensim_package corpus
    ...
    def create_dictionary(self):
        """
        Utility method to generate gensim_package-style Dictionary directly from
