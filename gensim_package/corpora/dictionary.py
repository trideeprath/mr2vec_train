...
logger = logging.getLogger('gensim_package.corpora.dictionary')
...
class Dictionary(utils.SaveLoad, Mapping):
    ...
    def merge_with(self, other):
        ...
        into a document using the new, merged dictionary (see :class:`gensim_package.interfaces.TransformationABC`).
