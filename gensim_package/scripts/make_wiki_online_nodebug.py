...
disk space; gensim_package's corpus iterators can work with compressed input, too.
...
Example: python -m gensim_package.scripts.make_wikicorpus ~/gensim_package/results/enwiki-latest-pages-articles.xml.bz2 ~/gensim_package/results/wiki_en
"""
