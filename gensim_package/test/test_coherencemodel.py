...
class TestCoherenceModel(unittest.TestCase):
    ...
    def testUMassMalletModel(self):
        """Perform sanity check to see if u_mass coherence works with LDA Mallet gensim_package wrapper"""
    ...
    def testCvMalletModel(self):
        """Perform sanity check to see if c_v coherence works with LDA Mallet gensim_package wrapper"""
        if not self.mallet_path:
            return
        try:
    ...
    def testCuciMalletModel(self):
        """Perform sanity check to see if c_uci coherence works with LDA Mallet gensim_package wrapper"""
        if not self.mallet_path:
            return
        try:
    ...
    def testCnpmiMalletModel(self):
        """Perform sanity check to see if c_npmi coherence works with LDA Mallet gensim_package wrapper"""
        if not self.mallet_path:
            return
        try:
    ...
    def testUMassVWModel(self):
        """Perform sanity check to see if u_mass coherence works with LDA VW gensim_package wrapper"""
        if not self.vw_path:
            return
        try:
    ...
    def testCvVWModel(self):
        """Perform sanity check to see if c_v coherence works with LDA VW gensim_package wrapper"""
        if not self.vw_path:
            return
        try:
    ...
    def testCuciVWModel(self):
        """Perform sanity check to see if c_uci coherence works with LDA VW gensim_package wrapper"""
        if not self.vw_path:
            return
        try:
    ...
    def testCnpmiVWModel(self):
        """Perform sanity check to see if c_npmi coherence works with LDA VW gensim_package wrapper"""
        if not self.vw_path:
            return
        try:
