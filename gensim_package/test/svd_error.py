...
Check truncated SVD error for the algo in gensim_package, using a given corpus. This script
...
Example: ./svd_error.py ~/gensim_package/results/wiki_en_v10k.mm.bz2 100000 10000
"""
