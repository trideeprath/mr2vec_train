...
each corpus for testing (or use all if no NUMDOCS is given).
    The two sample corpora can be downloaded from http://nlp.fi.muni.cz/projekty/gensim_package/wikismall.tgz
...
if __name__ == '__main__':
    ...
    # Difference between test #5 and test #1 is that the query in #5 is a gensim_package iterable
