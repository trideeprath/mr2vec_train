...
def randfname(prefix='gensim_package'):
...
def mock_data_row(dim=1000, prob_nnz=0.5, lam=1.0):
    """
    Create a random gensim_package sparse vector. Each coordinate is nonzero with
...
def mock_data(n_items=1000, dim=1000, prob_nnz=0.5, lam=1.0):
    """
    Create a random gensim_package-style corpus, as a list of lists of (int, float) tuples,
