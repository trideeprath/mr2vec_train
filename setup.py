...
if sys.version_info[:2] < (2, 6):
    raise Exception('This version of gensim_package needs Python 2.6 or later.')
...
********************************************************************
WARNING: %s could not
be compiled. No C extensions are essential for gensim_package to run,
...
model_dir = os.path.join(os.path.dirname(__file__), 'gensim_package', 'models')
gensim_dir = os.path.join(os.path.dirname(__file__), 'gensim_package')
...
setup(
    ...
    ext_modules=[
        Extension('gensim_package.models.word2vec_inner',
            sources=['./gensim_package/models/word2vec_inner.c'],
            include_dirs=[model_dir]),
        Extension('gensim_package.models.doc2vec_inner',
            sources=['./gensim_package/models/doc2vec_inner.c'],
            include_dirs=[model_dir])
    ],
    cmdclass=cmdclass,
    ...
    url='http://radimrehurek.com/gensim_package',
    download_url='http://pypi.python.org/pypi/gensim_package',
    ...
    test_suite="gensim_package.test",
    setup_requires=[
        'numpy >= 1.3'
    ],
    install_requires=[
